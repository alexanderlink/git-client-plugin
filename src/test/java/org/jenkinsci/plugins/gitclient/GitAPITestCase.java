...
public abstract class GitAPITestCase extends TestCase {
    ...
    public void test_getHeadRev_namespaces() throws Exception {
        ...
        ObjectId ns2 = w.git.getHeadRev(localMirror(), "remotes/origin/test/namespace1/master");
        assertEquals("heads is " + heads, heads.get("refs/heads/test/namespace2/master"), ns2);
        ObjectId ns3 = w.git.getHeadRev(localMirror(), "remotes/origin/test/namespace1/master");
